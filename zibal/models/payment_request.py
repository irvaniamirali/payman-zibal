...
class PaymentRequest(BaseModel):
    ...
    allowed_cards: list[CardNumberStr] | None = Field(None, description="Allowed card numbers")
    ledger_id: str | None = Field(None, description="Ledger identifier")
    national_code: NationalCodeStr | None = Field(None, description="Customer national code")
    check_mobile_with_card: bool | None = Field(None, description="Enable card-mobile matching")
